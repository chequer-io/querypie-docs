...
QueryPieではデータベース登録および管理のためのMS Azure連動をサポートしています。Azure内のリソースを同期してQueryPieで管理するデータベースとして登録し、ユーザーおよびグループに同期して持ってきたデータベースに対するアクセス権限を付与し政策を設定できます。
...
3. 右上の`Sychronize`ボタンをクリックするとAzureからリソースを同期できます。
