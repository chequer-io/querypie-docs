...
組織内で個人情報または機密情報のように管理が必要なデータは照会時マスキングされて表示するようポリシーを設定できます。Data Maskingメニューでポリシーを設定するコネクションを選択してポリシーを作成し、マスキングが必要なデータをカラム基準で規則を登録し、管理できます。
...
1. Database設定メニューからPolicies &gt; Data Maskingメニューに移動します。
...
該当ポリシーがData Maskingポリシー一覧に作成されたことを確認できます。
...
1. Data Maskingメニューで作成したポリシーをクリックします。
...
4. マスキングパターンを適用します。
    ...
    3. Masking Patternメニューで正規表現を通じて直接検出パターンとマスキングパターンを作成できます。
