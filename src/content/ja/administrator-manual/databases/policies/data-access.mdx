...
A. この場合、DBアカウント情報設定がされていないか間違った情報で設定されている可能性があります。Administrator &gt; Databases &gt; Connection Management &gt; DB Connectionsメニューで該当コネクション情報クリック後、**Database Username / Password情報を入力して保存**した後再び試行します。
</Callout>
...
4. Logタブの行をクリックすると詳細画面で実行されたクエリを確認できます。
  <figure data-layout="center" data-align="center">
  ![ログの詳細画面でクエリ内容確認](/administrator-manual/databases/policies/data-access/image-20250512-040436.png)
  <figcaption>
  ログの詳細画面でクエリ内容確認
  </figcaption>
  </figure>