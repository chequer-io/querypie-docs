...
実際[Secret Storeの使用](../../company-management/security)可否はSecurityメニューで設定できます。以下はQueryPieでサポート中のSecret Storeサービスリストです。
...
Active Directory連携情報を削除する前に、該当ADドメインと接続されたすべての個人アカウント（UPN）をまず削除する必要があります。Admin &gt; Servers&gt; Account Management &gt; Active Directoryタブで関連アカウントをすべて削除した後次の手順を進行してください。
</Callout>
