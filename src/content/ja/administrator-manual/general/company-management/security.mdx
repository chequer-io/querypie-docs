...
*  **Admin Page Access Control**  : 管理者ページにアクセスできる管理者のIPを制限するポリシーを設定します。トグルを活性化して特定IPアドレスまたは帯域から接続する管理者のみ管理者ページにアクセスするよう制限できます。<br/>
  <figure data-layout="center" data-align="center">
  ![AdminページIPアクセス遮断時画面](/administrator-manual/general/company-management/security/image-20251212-161723.png)
  <figcaption>
  AdminページIPアクセス遮断時画面
  </figcaption>
  </figure>
...
<figure data-layout="center" data-align="center">
![Each User設定のIPアクセス遮断時画面](/administrator-manual/general/company-management/security/image-20251218-082726.png)
<figcaption>
...
<figure data-layout="center" data-align="center">
![All User設定のIPアクセス遮断時画面](/administrator-manual/general/company-management/security/image-20251212-162103.png)
<figcaption>
