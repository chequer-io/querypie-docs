...
DACでマスキング政策によってマスキングされた項目に対して原本データの確認が必要な場合、Workflowを通じて管理者に一時的なマスキング解除を要求できます。マスキング解除はWorkflowを通じて要求することもでき、ウェブSQLエディターでマスキングされたデータを右クリックして表示されるUnmasking Requestメニューを通じても可能です。
