/**
 * Release Notes URL Redirects
 *
 * 파일명 변경에 따른 리다이렉트 매핑 (2026-02-04)
 * JavaScript 객체 키 정렬 문제 해결을 위해 파일명을 버전 형식으로 변경
 *
 * 형식: [이전 경로, 새 경로]
 * 예: ['1150', '11.5.0'] → /ko/release-notes/1150 → /ko/release-notes/11.5.0
 */
export const releaseNotesRedirects: [string, string][] = [
  ['1150', '11.5.0'],
  ['1140', '11.4.0'],
  ['1130', '11.3.0'],
  ['1120', '11.2.0'],
