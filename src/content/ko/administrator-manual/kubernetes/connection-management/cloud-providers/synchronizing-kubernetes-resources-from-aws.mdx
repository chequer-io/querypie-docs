...
|                           | **발생 시점**                                                                         | **문구**                                                                                                                                                    |
| ------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ac:emoticon]             | Dry Run 또는 Synchronize 동기화 시작                                                     | Cluster synchronization started.                                                                                                                          |
| [ac:emoticon]             | 신규 클러스터 추가 완료                                                                     | New Cluster is added: `{Cluster Name}` (`{API URL}`).                                                                                                     |
| [ac:emoticon]             | 기존 클러스터 정보 업데이트 완료                                                                | Cluster `{Cluster Name}` is updated                                                                                                                       |
| [ac:emoticon]             | 기존 클러스터 제거 완료                                                                     | Cluster `{Cluster Name}` is removed                                                                                                                       |
| [ac:emoticon]             | Dry Run 또는 Synchronize 동기화 성공적으로 종료                                               | Cluster synchronization succeeded.                                                                                                                        |
...
| [ac:emoticon]             | 이미 중복된 클러스터명이 확인되어 동기화 실패                                                         | Cluster synchronization failed. The cluster name “`{Cluster Name}`” is already in use by another cluster. To synchronize it, delete the existing cluster. |
| [ac:emoticon]             | Dry Run 또는 Synchronize 동기화 실패 종료                                                  | Cluster synchronization failed. + `{additional statement}`                                                                                                |
