...
<p align="center">
![image-20240512-134234.png](./synchronizing-kubernetes-resources-from-aws/image-20240512-134234.png)
...
3. 대상 EKS 클러스터가 위치한 리전(Region)으로 이동합니다. 
    * 예) ![image-20240512-134604.png](./synchronizing-kubernetes-resources-from-aws/image-20240512-134604.png) 
...
<p align="center">
![image-20240721-054036.png](./synchronizing-kubernetes-resources-from-aws/image-20240721-054036.png)
...
<p align="center">
![image-20240721-054313.png](./synchronizing-kubernetes-resources-from-aws/image-20240721-054313.png)
...
| ![image-20240822-082024.png](./synchronizing-kubernetes-resources-from-aws/image-20240822-082024.png) | EKS 클러스터의 인증 모드가 EKS API를 허용하지 않는 경우 동기화 스킵. ConfigMap 모드에서 EKS API를 허용하도록 변경 필요.  | Skipping sync. Cluster `{Cluster Name}`'s authentication mode blocks EKS access entry API. To manage access, enable EKS API access.                       |
