...
쿼리파이에서 INSERT / UPDATE / DELETE 쿼리 실행 완료시 전후 데이터를 기록합니다. 해당 스냅샷은 각 DB 커넥션 별 별도 DML Snapshot 설정을 활성화한 경우 결과 정보를 저장합니다. ([DB Connections](DB Connections) 내  **추가 설정하기 ** 참고)

## DML Snapshots 조회하기

<p align="center">
![image-20240730-094404.png](/administrator-manual/audit/database-logs/dml-snapshots/image-20240730-094404.png)
...
<p align="center">
![image-20240730-095257.png](/administrator-manual/audit/database-logs/dml-snapshots/image-20240730-095257.png)
