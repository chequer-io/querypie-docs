...
| --------------- | ----------------------------------------------- | -------------------------------------------------------------------------------------------- | ------------------ | -------------- | ----------------------------------- |
| QueryPie System | Users                                           | User Account Status <br/>사용자 계정 현황                                                           | O                  | X              | [ul]User Status                     |
| QueryPie System | Users                                           | User Account Management History <br/>사용자 계정 관리 이력                                            | O                  | X              | -                                   |
| QueryPie System | Users                                           | User Account Activation History <br/>사용자 계정 활성화/비활성화 이력                                      | O                  | X              | -                                   |
| QueryPie System | Users                                           | Group Status **[added-10.2.2]**<br/>그룹 현황                                                    | X                  | X              | -                                   |
| QueryPie System | Users                                           | Group Membership History **[added-10.2.2]**<br/>그룹 멤버 추가/삭제 이력                               | X                  | X              | -                                   |
| QueryPie System | Administrator                                   | Administrator Status <br/>관리자 현황                                                             | O                  | X              | -                                   |
| QueryPie System | Administrator                                   | Admin Role History <br/>관리자 권한 부여/회수 이력                                                      | O                  | X              | -                                   |
| QueryPie System | Administrator                                   | Admin Activity History <br/>관리자 행위 이력                                                        | O                  | X              | -                                   |
| QueryPie System | Login                                           | User Login History <br/>사용자 로그인 이력                                                           | O                  | X              | -                                   |
| QueryPie System | Login                                           | Login IPs by User <br/>사용자 별 로그인 IP 이력                                                       | O                  | X              | -                                   |
| QueryPie System | Security Settings                               | Authentication Method <br/>사용자 인증 방식                                                         | X                  | X              | -                                   |
| QueryPie System | Security Settings                               | Security Configuration Stauts **[updated-10.2.2]**<br/>보안 설정 현황                              | X                  | X              | -                                   |
| QueryPie DAC    | Databases **[added-10.2.2]**                    | DB Connection Status<br/>DB 커넥션 현황                                                           | X                  | O              | -                                   |
| QueryPie DAC    | Databases **[added-10.2.2]**                    | DB Connection Management History<br/>DB 커넥션 추가/삭제 이력                                         | X                  | O              | -                                   |
| QueryPie DAC    | DB Access Control                               | DB Access Control - Assigned Status <br/>DB 접근 권한 부여 현황                                      | O                  | O              | -                                   |
| QueryPie DAC    | DB Access Control                               | DB Access Control Logs <br/>DB 접근 권한 부여/회수 이력                                                | O                  | O              | -                                   |
| QueryPie DAC    | DB Access & Queries                             | DB Access History <br/>DB 접근 이력                                                              | O                  | O              | [ul]Time Range                      |
| QueryPie DAC    | DB Access & Queries                             | Query Execution History <br/>쿼리 실행 이력                                                        | O                  | O              | -                                   |
| QueryPie DAC    | Workflow Logs - DB **[added-10.2.2]**           | DAC Type Requests<br/>DAC 유형 요청                                                              | X                  | O              | -                                   |
| QueryPie SAC    | Servers <br/>**[added-10.2.2]**                 | Server Status<br/>서버 현황                                                                      | X                  | O              | -                                   |
| QueryPie SAC    | Servers <br/>**[added-10.2.2]**                 | Server Management History<br/>서버 추가/삭제/변경 이력                                                 | X                  | O              | -                                   |
| QueryPie SAC    | Server Groups **[added-10.2.2]**                | Server Group Status<br/>서버 그룹 현황                                                             | X                  | X              | -                                   |
| QueryPie SAC    | Server Groups **[added-10.2.2]**                | Server Group Management History<br/>서버 그룹 추가/삭제/변경 이력                                        | X                  | X              | -                                   |
| QueryPie SAC    | Server Account & Password **[added-10.2.2]**    | Provisioned Server Account Status<br/>프로비저닝된 서버 계정 현황                                        | X                  | O              | -                                   |
| QueryPie SAC    | Server Account & Password **[added-10.2.2]**    | Server Account Provisioning History<br/>서버 계정 프로비저닝 이력                                       | X                  | O              | -                                   |
| QueryPie SAC    | Server Access Control                           | Direct Permission Status by User/Group **[updated-10.2.2]**<br/>사용자/그룹별 Direct Permission 현황 | O                  | O              | -                                   |
| QueryPie SAC    | Server Access Control                           | Direct Permission Change History <br/>Direct Permission 변경 이력                                | O                  | O              | -                                   |
| QueryPie SAC    | Server Access Control                           |  *Server Role Status by User * **[deprecated-10.2.2]**<br/> *사용자별 서버 역할 현황*                  |  *O*               |  *O*           |  *-*                                |
| QueryPie SAC    | Server Access Control                           | Role-Granted Users by Role **[added-10.2.2]**<br/>역할별 역할 부여 사용자 현황                           | O                  | X              | -                                   |
| QueryPie SAC    | Server Access Control                           | Accessible Servers by Role **[added-10.2.2]**<br/>역할별 접근 가능 서버 현황                            | X                  | O              | -                                   |
| QueryPie SAC    | Server Access Control                           | Server Role & Policy Management History **[added-10.2.2]**<br/>서버 역할 및 정책 변경 이력              | X                  | X              | -                                   |
| QueryPie SAC    | Server Access Control                           | Server Role Grant/Revocation History <br/>서버 역할 부여/회수 이력                                     | O                  | O              | -                                   |
| QueryPie SAC    | Server Sessions and Commands                    | Server Access History <br/>서버 접근 이력                                                          | O                  | O              | [ul]Time RangeResultAction TypeRole |
| QueryPie SAC    | Server Sessions and Commands                    | Command History <br/>명령어 이력                                                                  | O                  | O              | [ul]Keyword                         |
| QueryPie SAC    | Server Sessions and Commands                    | Command Template Status <br/>명령어 템플릿 현황                                                      | X                  | X              | -                                   |
| QueryPie SAC    | Server Sessions and Commands                    | Command Template Management History <br/>명령어 템플릿 관리 이력                                       | X                  | X              | -                                   |
| QueryPie SAC    | Server Sessions and Commands                    | Command Whitelist Grant/Revocation History <br/>명령어 일시 허용 권한 부여/회수 이력                        | O                  | O              | -                                   |
| QueryPie SAC    | Server Sessions and Commands                    | Restricted Commands <br/>차단 명령어 이력                                                           | O                  | O              | [ul]Keyword                         |
| QueryPie SAC    | Workflow Logs - Servers <br/>**[added-10.2.2]** | SAC Type Requests<br/>SAC 유형 요청                                                              | X                  | O              | -                                   |
