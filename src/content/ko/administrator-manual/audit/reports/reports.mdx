...
| --------------- | -------------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------- | ------------ | ----------------------------------- |
| QueryPie System | Users                                        | User Account Status  사용자 계정 현황                                                           | O                | X            | [ul]User Status                     |
...
| QueryPie System | Users                                        | Group Status **[added-10.2.2]** 그룹 현황                                                    | X                | X            | -                                   |
| QueryPie System | Users                                        | Group Membership History **[added-10.2.2]** 그룹 멤버 추가/삭제 이력                               | X                | X            | -                                   |
...
| QueryPie System | Security Settings                            | Security Configuration Stauts **[updated-10.2.2]** 보안 설정 현황                              | X                | X            | -                                   |
| QueryPie DAC    | Databases **[added-10.2.2]**                 | DB Connection Status DB 커넥션 현황                                                           | X                | O            | -                                   |
| QueryPie DAC    | Databases **[added-10.2.2]**                 | DB Connection Management History DB 커넥션 추가/삭제 이력                                         | X                | O            | -                                   |
...
| QueryPie DAC    | DB Access & Queries                          | DB Access History  DB 접근 이력                                                              | O                | O            | [ul]Time Range                      |
| QueryPie DAC    | DB Access & Queries                          | Query Execution History  쿼리 실행 이력                                                        | O                | O            | -                                   |
| QueryPie DAC    | Workflow Logs - DB **[added-10.2.2]**        | DAC Type Requests DAC 유형 요청                                                              | X                | O            | -                                   |
| QueryPie SAC    | Servers  **[added-10.2.2]**                  | Server Status 서버 현황                                                                      | X                | O            | -                                   |
| QueryPie SAC    | Servers  **[added-10.2.2]**                  | Server Management History 서버 추가/삭제/변경 이력                                                 | X                | O            | -                                   |
| QueryPie SAC    | Server Groups **[added-10.2.2]**             | Server Group Status 서버 그룹 현황                                                             | X                | X            | -                                   |
| QueryPie SAC    | Server Groups **[added-10.2.2]**             | Server Group Management History 서버 그룹 추가/삭제/변경 이력                                        | X                | X            | -                                   |
| QueryPie SAC    | Server Account & Password **[added-10.2.2]** | Provisioned Server Account Status 프로비저닝된 서버 계정 현황                                        | X                | O            | -                                   |
| QueryPie SAC    | Server Account & Password **[added-10.2.2]** | Server Account Provisioning History 서버 계정 프로비저닝 이력                                       | X                | O            | -                                   |
| QueryPie SAC    | Server Access Control                        | Direct Permission Status by User/Group **[updated-10.2.2]** 사용자/그룹별 Direct Permission 현황 | O                | O            | -                                   |
| QueryPie SAC    | Server Access Control                        | Direct Permission Change History  Direct Permission 변경 이력                                | O                | O            | -                                   |
| QueryPie SAC    | Server Access Control                        | *Server Role Status by User * **[deprecated-10.2.2]**  *사용자별 서버 역할 현황*                   | *O*              | *O*          | *-*                                 |
| QueryPie SAC    | Server Access Control                        | Role-Granted Users by Role **[added-10.2.2]** 역할별 역할 부여 사용자 현황                           | O                | X            | -                                   |
| QueryPie SAC    | Server Access Control                        | Accessible Servers by Role **[added-10.2.2]** 역할별 접근 가능 서버 현황                            | X                | O            | -                                   |
| QueryPie SAC    | Server Access Control                        | Server Role & Policy Management History **[added-10.2.2]** 서버 역할 및 정책 변경 이력              | X                | X            | -                                   |
| QueryPie SAC    | Server Access Control                        | Server Role Grant/Revocation History  서버 역할 부여/회수 이력                                     | O                | O            | -                                   |
| QueryPie SAC    | Server Sessions and Commands                 | Server Access History  서버 접근 이력                                                          | O                | O            | [ul]Time RangeResultAction TypeRole |
| QueryPie SAC    | Server Sessions and Commands                 | Command History  명령어 이력                                                                  | O                | O            | [ul]Keyword                         |
...
| QueryPie SAC    | Server Sessions and Commands                 | Restricted Commands  차단 명령어 이력                                                           | O                | O            | [ul]Keyword                         |
| QueryPie SAC    | Workflow Logs - Servers  **[added-10.2.2]**  | SAC Type Requests SAC 유형 요청                                                              | X                | O            | -                                   |
...
복제하려는 보고서를 목록에서 선택한 뒤 [ac:emoticon]  `Duplicate Task` 버튼을 클릭하면, 기존에 생성했던 보고서를 복제하여 새로운 보고서 태스크를 생성할 수 있습니다.
