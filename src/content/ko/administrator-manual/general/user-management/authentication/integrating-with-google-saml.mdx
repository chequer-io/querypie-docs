...
<p align="center">
![screenshot-20240902-162650.png](./integrating-with-google-saml/screenshot-20240902-162650.png)
</p>


2. `앱 추가` 버튼을 누른 후 `맞춤 SAML 앱 추가`를 클릭합니다.
<p align="center">
![image-20240902-073821.png](./integrating-with-google-saml/image-20240902-073821.png)
</p>


3. 앱 세부정보를 입력하는 1단계 페이지 입니다. 앱 이름 항목에 ‘QueryPie-SSO’를 입력 후 `계속` 버튼을 클릭합니다.
<p align="center">
![screenshot-20240902-164038.png](./integrating-with-google-saml/screenshot-20240902-164038.png)
</p>


4. 2단계 페이지에서는 다음의 값들을 입력합니다. 입력 완료 후 `계속` 버튼을 클릭하여 3단계로 이동합니다.
<p align="center">
![screenshot-20240902-164356.png](./integrating-with-google-saml/screenshot-20240902-164356.png)
</p>
...
<p align="center">
![screenshot-20240902-164739.png](./integrating-with-google-saml/screenshot-20240902-164739.png)
</p>
...
<p align="center">
![screenshot-20240902-164955.png](./integrating-with-google-saml/screenshot-20240902-164955.png)
</p>


7. 생성이 성공적으로 완료되면 다음과 같이 목록에 신규 추가된 앱이 표시됩니다. 사용 설정을 위해 해당 앱을 클릭합니다.
<p align="center">
![screenshot-20240902-165202.png](./integrating-with-google-saml/screenshot-20240902-165202.png)
</p>


8. 앱의 상세 정보에서 `메타데이터 다운로드`를 클릭하여 파일을 다운로드 받은 후 `사용자 액세스` 항목을 클릭합니다.
<p align="center">
![screenshot-20240902-165512.png](./integrating-with-google-saml/screenshot-20240902-165512.png)
</p>


9. 서비스 상태를 ‘모든 사용자에 사용하도록 설정’을 선택한 상태로 `저장` 버튼을 클릭합니다.
<p align="center">
![screenshot-20240902-165647.png](./integrating-with-google-saml/screenshot-20240902-165647.png)
</p>
...
<p align="center">
![screenshot-20240902-170029.png](./integrating-with-google-saml/screenshot-20240902-170029.png)
</p>
...
<p align="center">
![image-20240723-073353.png](./integrating-with-google-saml/image-20240723-073353.png)
</p>
