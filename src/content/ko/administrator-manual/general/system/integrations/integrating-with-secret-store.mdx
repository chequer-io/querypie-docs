...
실제 [Secret Store의 사용](https://chequer.atlassian.net/wiki/spaces/QM/pages/544377613) 여부는 Security메뉴에서 설정할 수 있습니다. 다음은 QueryPie에서 지원 중인 Secret Store 서비스 목록입니다.
...
6. 필요한 모든 정보를 입력했다면,  **Verify integration**  버튼을 클릭합니다.
    1. 모든 정보가 올바르게 입력되었다면 [ac:emoticon] Success 메시지가 표시됩니다.
7. `OK` 버튼을 클릭하여 저장합니다.
