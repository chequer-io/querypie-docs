...
![Splunk 연계 권장 아키텍쳐](/administrator-manual/general/system/integrations/integrating-with-splunk/screenshot-20240613-174947.png)
<figcaption>
Splunk 연계 권장 아키텍쳐
</figcaption>
</figure>
...
<figure data-layout="center" data-align="center">
![(좌) TCP / UDP 설정 화면 (우) HTTP / HTTPS 설정 화면](/administrator-manual/general/system/integrations/integrating-with-splunk/image-20240523-101104.png)
<figcaption>
...
<Callout type="info">
11.3.0에서 Timezone 설정이 추가 되었습니다. 전에 Syslog (Legacy)에서만 Timezone 설정을 할 수 있었으나 SIEM 관련 설정 모두 (Syslog, Splunk) Timezone 설정을 할 수 있도록 변경되었습니다. 또한 New DAC Policy Management 기능에 의해 발생된 이벤트에 대한 스트리밍 전송기능이 추가되었습니다. (Select Event Items에서 DAC Policy Audit Logs를 선택.)
</Callout>
