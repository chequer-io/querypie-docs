...
| KAC           | K8s API Request           | 쿠버네티스 API 요청 알림[ul]10.2.2 이후 버전에서 지원 |

<Callout type="info">
11.1.0 부터 New DAC Policy Managment 기능이 활성화 된 경우 아래와 같은 알림 유형을 사용할 수 있습니다. 
* New Request - DB Policy Exception Request DB Policy Exception Request 는 Unmasking과 Restriced Data Access 두가지 유형이 있으나 구분해서 알림 생성을 할 수는 없습니다.
* Data Access
...
Data Access 알림은 Column Data Masking, Table Access Restriction, Column Access Restriction, Sensitive Data Access Monitoring 의 네가지 **policy type** 을 선택할 수 있습니다.

<p align="center">
<div>[image-20250727-222007.png]()</div>
</p>
