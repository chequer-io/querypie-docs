...
*  **User Inactivity Timeout (on agent)** :  <br/> Agent Session Timeout 기능에 추가로 Agent가 사용자의 마우스, 키보드 입력을 모니터링하고 지정된 시간을 초과하여 행위가 없으면 세션을 강제 종료합니다. 유휴 상태인 경우, 장시간 쿼리를 실행하고 있어도 마우스 및 키보드 움직임이 없다면 무조건 세션이 종료되어 로그아웃처리 됩니다. 

<Callout type="info">
**User Inactivity Timeout (on agent) 설정 예시**
* Agent Inactivity Timeout 15분일 경우를 가정하면, <br/> 1분이 지난 12:09분에 사용자 액션 감지 했다면4. 12:09분에(t+1분) 마지막 활동을 한것으로 확인되면, 15분 후인 12:24분으로 갱신
    * 12:00분에 로그인
        1. 최초 세션 만료 시간은  **12:15:00** 
    * 12:08분에(t+8분) 마지막 활동을 한것으로 확인되면, 15분 후인 12:23분으로 갱신
        1. 새로운 세션 만료 시간:  **12:23:00** 
    * 새로운 세션 만료 시간:  **12:24:00** 한 시간을 검사합니다.
</Callout>
...
<figure data-layout="center" data-align="center">
![QueryPie Web Access Control &gt; All Users 에 등록된 IP 와 일치하지 않을 경우](/administrator-manual/general/company-management/security/image-20240121-073718.png)
<figcaption>
QueryPie Web Access Control &gt; All Users 에 등록된 IP 와 일치하지 않을 경우
</figcaption>
</figure>
<figure data-layout="center" data-align="center">
![Users &gt; Update User 에 등록된 Allowed Zone 과 일치하지 않을 경우](/administrator-manual/general/company-management/security/image-20240121-074246.png)
<figcaption>
...
<figure data-layout="center" data-align="center">
![DB Connection 상세 페이지 내 Connection Information &gt; Secret Store 선택](/administrator-manual/general/company-management/security/screenshot-20240726-185946.png)
<figcaption>
...
<figure data-layout="center" data-align="center">
![Server Group 상세 페이지 내 Accounts &gt; Secret Store 선택](/administrator-manual/general/company-management/security/screenshot-20240726-190034.png)
<figcaption>
