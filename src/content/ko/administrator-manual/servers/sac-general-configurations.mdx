...
![image-20251218-084954.png](/administrator-manual/servers/sac-general-configurations/image-20251218-084954.png)
</figure>
...
*  **Resource IP Access Control Configuration :** 서버 접속 허용 IP 접근 제어 설정
    ...
    * `Add Configuration` 버튼 클릭 시, 모달이 생성되며 이하의 정보를 기입하여 `Add` 버튼을 클릭하여 추가 (우측 상단의 `Save Changes` 버튼 클릭 이전까지 미반영)
      <figure data-layout="center" data-align="center">
      ![image-20240829-095257.png](/administrator-manual/servers/sac-general-configurations/image-20240829-095257.png)
      </figure>
...
<Callout type="info">
사용자는 Server Access Request를 통하여 서버에 대한 Direct Permission 을 할당받을 수 있습니다.
...
<Callout type="info">
사용자는 Server Privilege Request를 통하여 서버에 대한 특권을 할당받을 수 있습니다.
