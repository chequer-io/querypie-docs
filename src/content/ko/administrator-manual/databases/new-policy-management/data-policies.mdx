...
6.  **DML Query Approval Enforcement**  
    ...
    * 이 정책을 생성하기 전 General &gt; Workflow Management &gt; Approval Rules에서 SQL Request Type의 Approval Rule을 먼저 생성해 두어야 합니다. `INSERT`, `UPDATE`, `DELETE`를 수행하는 것은 수행하는 사람에게 해당 privilege가 부여되어 있다는 것을 전제로 합니다. 쿼리를 수행하는 사람이 요청자 본인이 되도록 하려면 아래 그림과 같이 Execution 항목의 Assignee for Execution 에 “Allow Assginee selection (All Users)가 선택되어 있어야 `INSERT`, `UPDATE`, `DELETE` 권한이 있지만 관리자가 아닌사람이 승인을 거쳐 쿼리를 수행할 수 있습니다.<br/>
      <figure data-layout="center" data-align="center">
      ![General &gt; Workflow Management &gt; Approval Rules에 SQL Request 형식의 Approval rule을 생성](/administrator-manual/databases/new-policy-management/data-policies/image-20250629-153240.png)
      <figcaption>
    ...
    *  Approval Rule이 생성되어 있으면 아래 그림과 같이 정책과 연계할 Approval Rule을 지정할 수 있습니다.<br/>
      <figure data-layout="center" data-align="center">
      ![Databases&gt;Policy Management&gt;Data Policies에서 SQL Request 형식의 미리 생성한 Approval Rule을 지정](/administrator-manual/databases/new-policy-management/data-policies/image-20250629-154218.png)
      <figcaption>
...
2.  **Specific data path** : 특정 데이터 경로를 직접 지정하는 옵션입니다. **[11.0.0]** 
    * 이 옵션을 선택한 뒤 Add tartget 버튼을 눌러 출력되는 팝업 대화창에서 Database, Schema, Table, Column을 지정할 수 있고 정규표현식을 사용할 수도 있습니다.  <br/>  <br/> 
      <figure data-layout="center" data-align="center">
      ![직접 경로 지정](/administrator-manual/databases/new-policy-management/data-policies/image-20250629-162342.png)
      <figcaption>
      직접 경로 지정
      </figcaption>
      </figure>
      <figure data-layout="center" data-align="center">
      ![정규식을 사용하여 대상 지정](/administrator-manual/databases/new-policy-management/data-policies/image-20250629-162448.png)
      <figcaption>
      정규식을 사용하여 대상 지정
      </figcaption>
      </figure>
