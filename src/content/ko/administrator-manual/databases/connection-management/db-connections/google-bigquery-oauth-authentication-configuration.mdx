...
Google Cloud API Integration 설정 방법은 이 [문서](https://chequer.atlassian.net/l/cp/jc3puCt5)를 참고 부탁드립니다.
...
![새로운 BigQuery 커넥션을 생성할 때 Authentication Method 지정](/administrator-manual/databases/connection-management/db-connections/google-bigquery-oauth-authentication-configuration/image-20250116-112226.png)
<figcaption>
