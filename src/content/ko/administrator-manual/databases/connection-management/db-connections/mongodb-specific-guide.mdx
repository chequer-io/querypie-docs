...
* options : /? 뒤에 붙는 접속에 관련된 옵션. 여러개의 옵션을 사용할 경우 &로 붙여서 사용합니다.  ex. /?authSource=admin&replicaSet=rs0
...
### 2. MongoDB 커넥션 생성하기
<p align="center">
<div>[image-20240730-113638.png]()</div>
...
#### &lt; Standard Connection &gt;
<p align="center">
<div>[image-20240730-114050.png]()</div>
</p>
...
3. `Cluster` 스위치를 를 켜서 클러스터 입력을 활성화한 후 다음의 정보들을 입력합니다.
    ...
    4. `Add Instance` 버튼을 눌러 각 멤버 호스트를 인스턴스로 추가합니다.
        ...
        3. Expose 는 커넥션 정보에서의 개별 인스턴스의 노출 여부를 결정할 수 있는 옵션입니다.   **멀티호스트 기능을 사용하기 위해서는 반드시 인스턴스가 expose 상태여야 하므로 반드시 ** `Expose` **옵션을 활성화 시킵니다.**

<p align="center">
<div>[image-20240730-114226.png]()</div>
</p>
...
#### &lt; +srv Connection &gt;
<p align="center">
<div>[image-20240730-114540.png]()</div>
</p>
...
<p align="center">
<div>[image-20240730-114833.png]()</div>
</p>
...
<p align="center">
<div>[image-20240731-050745.png]()</div>
</p>
...
### 마스킹 정책에 규칙 등록하기
<p align="center">
<div>[image-20240730-115120.png]()</div>
...
<p align="center">
<div>[image-20240730-115402.png]()</div>
...
<p align="center">
<div>[image-20240730-120312.png]()</div>
</p>
...
<p align="center">
<div>[image-20240730-120011.png]()</div>
*Administrator &gt; Databases &gt; Policies &gt; Data Access &gt; Add Rule List*
</p>

<p align="center">
<div>[image-20240730-120215.png]()</div>
</p>
...
<p align="center">
<div>[image-20240730-120351.png]()</div>
*Administrator &gt; Databases &gt; Policies &gt; Data Access &gt; Add Rule List*
</p>

<p align="center">
<div>[image-20240730-120421.png]()</div>
</p>
...
<p align="center">
<div>[image-20240730-120507.png]()</div>
*Administrator &gt; Databases &gt; Policies &gt; Data Access &gt; Add Rule List*
</p>

<p align="center">
<div>[image-20240730-120544.png]()</div>
</p>
