...
* Unmasking Expiration : 마스킹 해제를 요청할 기간을 설정할 수 있습니다.Time Duration 선택시, 분 단위로 입력 가능하고 최소는 1분, 최대는 44,640분으로 요청할 수 있습니다. Time Duration 의 경우, 승인 시점을 기준으로 동작합니다.Urgent Mode 사용하는 경우, Request 등록 시점을 기준으로 마스킹 해제된 데이터를 확인할 수 있습니다.End Date 선택시, 일자와 시간을 기준으로 선택 가능하며, 최소는 현재 시간, 최대는 30일로 요청할 수 있습니다.
  1. Time Duration 선택시, 분 단위로 입력 가능하고 최소는 1분, 최대는 44,640분으로 요청할 수 있습니다. Time Duration 의 경우, 승인 시점을 기준으로 동작합니다.Urgent Mode 사용하는 경우, Request 등록 시점을 기준으로 마스킹 해제된 데이터를 확인할 수 있습니다.
...
<p align="center">
<div>[image-20241103-071004.png]()</div>
