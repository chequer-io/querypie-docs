...
<p align="center">
<div>[image-20240731-114320.png]()</div>
*QueryPie Web &gt; Database Access Control &gt; Databases*
</p>

1. QueryPie 로그인 후 상단 메뉴 바 옵션에서 Databases를 클릭합니다.
2. 좌측 패널에 접속 가능한 데이터베이스 커넥션들이 표시됩니다.
3. 접속하고자 하는 커넥션을 클릭하면 우측에 세부 정보가 표시되며, Connect버튼을 클릭하여 접속합니다.
...
### 1. 좌상단 개체 패널
<p align="center">
<div>[스크린샷 2024-08-02 오후 2.14.39.png]()</div>
...
### 2. 좌측 개체 패널
<p align="center">
<div>[스크린샷 2024-08-02 오후 2.19.27.png]()</div>
*SQL Editor &gt; Connection Panel*
</p>
...
### 3. 상단 툴바
<p align="center">
<div>[image-20240731-115955.png]()</div>
...
* Save : SQL 파일을 저장할 수 있습니다. Query Sharing 설정이 On인 경우 Git Repository에 SQL 파일이 저장됩니다.
...
* Auto commit : 수행한 작업 쿼리를 자동으로 커밋을 활성화합니다.Commit : 수행한 작업 쿼리를 수동으로 확정합니다.List : 작업 확정되지 않은 쿼리 목록을 나열합니다.Rollback : 직전 커밋 직후의 단계로 회귀를 수행합니다.
...
<p align="center">
<div>[image-20240802-052240.png]()</div>
...
### 3. Queries 패널
<p align="center">
<div>[image-20240802-052539.png]()</div>
...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Info:</strong> 해당 기능을 사용하기 위해서는 관리자가 쿼리 공유 설정을 사전에 해야 합니다. ( [General](General) &gt; **쿼리 공유 설정** 참고) 

</div>

### 4. Object Info 패널
<p align="center">
<div>[image-20240802-053427.png]()</div>
...
### 5. SQL History 패널
<p align="center">
<div>[image-20240802-054007.png]()</div>
...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Info:</strong> **Q 웹 에디터에서 실행할 수 있는 쿼리 크기에 제한이 있나요?** 
...
<p align="center">
<div>[image-20241031-233232.png]()</div>
</p>
