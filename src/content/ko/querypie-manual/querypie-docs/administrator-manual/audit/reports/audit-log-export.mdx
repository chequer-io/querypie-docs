...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Note:</strong> Audit Log Export 기능 추가에 따라, 각 로그 화면에서 제공되던 ‘Excel File Download’ 버튼은 QueryPie v9.15.0부터 지원이 중단되었습니다. 
...
지원하는 표현식 :  == (equals), != (not equals), contains예 : x == 'abc', x != 'abc', contains(x, 'ab')
