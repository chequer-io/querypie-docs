...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Info:</strong> **사용자가 그룹에 포함된 경우, 그룹과 사용자를 대상으로 같은 커넥션에 대해 각각 다른 권한을 적용하면 어떻게 되나요?** 
...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Info:</strong> **테이블 태그로 접근제어하기**   Databases &gt; General &gt; Configurations에서 New DAC Policy Management 를 활성화한 경우, 
[ac:image]
[ri:attachment]
