...
4. 테이블에서 아래의 컬럼 정보를 제공합니다:Name : 웹앱명URL : 웹앱 URL 또는 도메인Description : 웹앱 설명Tags : 웹앱에 달린 태그 목록User Activity Recording : 사용자 활동 기록 여부 (웹앱 접근 및 사용 기록 추적 설정)Created At : 웹앱 생성일시Updated At : 웹앱 마지막 수정일시
  1. Name : 웹앱명
  2. URL : 웹앱 URL 또는 도메인
  3. Description : 웹앱 설명
  4. Tags : 웹앱에 달린 태그 목록
...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Note:</strong> Web App 삭제 시 사용자/그룹에 부여된 해당 웹앱에 대한 접근 권한 모두 일괄 삭제됩니다. 
