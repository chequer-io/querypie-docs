...
1. Google 관리 콘솔 홈페이지에 접속 후 왼쪽 메뉴에서 앱 &gt; 웹 및 모바일 앱을 클릭합니다.

<p align="center">
<div>[스크린샷 2024-09-02 오후 4.26.50.png]()</div>
</p>

2. 앱 추가 버튼을 누른 후 맞춤 SAML 앱 추가를 클릭합니다.
...
6. Google 본인 인증을 위한 비밀번호를 입력 후 다음을 클릭하면 생성이 완료됩니다.
...
8. 앱의 상세 정보에서 메타데이터 다운로드를 클릭하여 파일을 다운로드 받은 후  사용자 액세스 항목을 클릭합니다.
