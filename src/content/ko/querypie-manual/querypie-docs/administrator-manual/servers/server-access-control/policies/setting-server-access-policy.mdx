...
* commandRef : 접속시 적용할 명령어 템플릿선택한 Command Template의 내용은 Command Policy Detail 아코디언을 펼쳐서 확인 가능명령어 템플릿의 생성 및 관리 방법은 Command Templates 참고Allow / Deny 명령어 템플릿을 모두 적용한 경우, Deny 우선 적용
...
## Policy 코드 편집하기
<p align="center">
<div>[image-20241209-122232.png]()</div>
...
4. 이하의 방법을 활용하여 코드 에디터 창에서 원하는 정책 내용을 수정합니다.하단의 Errors 탭을 통해 직접 수정한 코드의 오류를 디버깅합니다.하단의 Tips 탭을 통해 각 항목에 대한 정의 방법을 확인하여 코드에 반영합니다.우측의 버튼을 통해 코드에 내용을 삽입 또는 수정합니다.
