...
<p align="center">
<div>[image-20240902-045519.png]()</div>
...
4. 테이블에서 이하의 컬럼 정보를 제공합니다:Name : 서버명Host : 서버의 IP 또는 도메인Cloud Provider : 연결 플랫폼 (수동 등록 서버의 경우, 하이픈으로 표기)Server OS : 서버의 OSOS Version : 서버 OS의 상세 버전Tag : 서버에 달린 태그 목록Server Agent : (Windows Server만 해당) Server Agent Online/Offline 여부 및 버전 정보Created At : 서버 생성일시Updated At : 서버 마지막 수정일시
  1. Name : 서버명
...
3. 수동으로 개별 서버 등록하기 가이드를 참고하여 서버를 등록합니다.

## Server 삭제하기
<p align="center">
<div>[image-20240723-162214.png]()</div>
</p>
...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Note:</strong> Server 삭제 시 사용자/그룹에 부여된 해당 서버에 대한 접근 권한 모두 일괄 삭제됩니다. 
