...
4. 테이블에서 이하의 컬럼 정보를 제공합니다:Name : 서버 그룹명Description : 관리자가 설정한 서버 그룹에 대한 설명Server Tags : 서버 그룹에 포함되는 서버 태그 조건Created At : 서버 그룹 생성일시Updated At : 서버 그룹 마지막 수정일시
  1. Name : 서버 그룹명
...
3. 서버를 그룹으로 관리하기 가이드를 참고하여 서버를 등록합니다.
