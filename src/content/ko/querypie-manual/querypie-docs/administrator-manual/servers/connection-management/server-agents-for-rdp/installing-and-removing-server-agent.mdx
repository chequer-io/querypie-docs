...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Info:</strong> **CONFIG 파일 설명** 
...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Note:</strong> **RDP연결에 사용할 Port의 변경** 
[ul]
[li]
...
<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Info:</strong> Deletion Key는 일단위로 변경되며, QueryPie가 동작하는 서버의 날짜와 삭제 대상 Windows 서버의 날짜가 동일해야 삭제가 가능합니다. 

</div>

<div class="alert alert-info">
  <i class="fas fa-info-circle"></i> <strong>Note:</strong> **Windows에서 Deletion Key가 틀리는 경우** 
[ul]
[li]
