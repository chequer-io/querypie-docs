...
4. 설치 완료된 QueryPie Agent를 실행하면 Host 최초 등록 페이지가 열립니다. QueryPie Host 입력란에 미리 복사해뒀던 QueryPie URL을 입력하고 `Next` 버튼을 클릭하면 로그인 화면으로 진입하게 됩니다.
...
2. 메뉴에서 Connection Information을 선택합니다.
