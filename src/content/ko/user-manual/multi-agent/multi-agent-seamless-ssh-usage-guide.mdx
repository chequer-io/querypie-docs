...
```
<p align="center">
[qpctl-host-use-without-hostname.mov](./multi-agent-seamless-ssh-usage-guide/qpctl-host-use-without-hostname.mov)
</p>
...
```
<p align="center">
[qpctl-host-use-with-hostname.mov](./multi-agent-seamless-ssh-usage-guide/qpctl-host-use-with-hostname.mov)
</p>
