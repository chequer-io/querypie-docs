...
<p align="center">
![screenshot-20240804-173002.png](./user-agent/screenshot-20240804-173002.png)
*QueryPie Web &gt; 프로필 메뉴*
</p>

2. QueryPie Agent Downloads 팝업창이 실행되면 Step 1에서 사용 중인 PC 운영체제에 맞는 설치 파일을 다운로드한 후 Step 3에 있는 QueryPie URL을 복사해 둡니다.
<p align="center">
![image-20240723-154847.png](./user-agent/image-20240723-154847.png)
...
<p align="center">
![screenshot-20240804-173713.png](./user-agent/screenshot-20240804-173713.png)
</p>

2. 웹 브라우저가 열리면, 로그인 페이지에서 인증정보를 입력하고, `Continue` 버튼을 클릭합니다.
<p align="center">
![screenshot-20240729-171236.png](./user-agent/screenshot-20240729-171236.png)
*QueryPie Web &gt; Agent Login Page*
</p>

3. 로그인을 성공하면 아래와 같이 로그인 성공 화면이 표시되며 이후 Agent로 돌아갑니다.
<p align="center">
![screenshot-20240729-171314.png](./user-agent/screenshot-20240729-171314.png)
*QueryPie Web &gt; Agent Login Success Page*
</p>

4. Agent 열기를 명시적으로 수행하여 인증정보를 Agent로 전달합니다.
<p align="center">
![screenshot-20240804-174209.png](./user-agent/screenshot-20240804-174209.png)
...
<p align="center">
![screenshot-20240730-151001.png](./user-agent/screenshot-20240730-151001.png)
*Agent &gt; DB Connection Information*
</p>

2. 위의 접속 정보를 3rd Party 클라이언트에 입력하면 DB 커넥션 접속이 가능합니다.
<p align="center">
![agent-07.png](./user-agent/agent-07.png)
...
<p align="center">
![screenshot-20240730-162653.png](./user-agent/screenshot-20240730-162653.png)
...
<p align="center">
![screenshot-20240730-161729.png](./user-agent/screenshot-20240730-161729.png)
...
<p align="center">
![screenshot-20240730-162532.png](./user-agent/screenshot-20240730-162532.png)
...
<p align="center">
![kubernetes-agent-access-flow.png](./user-agent/kubernetes-agent-access-flow.png)
</p>
...
<p align="center">
![screenshot-20240730-152705.png](./user-agent/screenshot-20240730-152705.png)
...
<p align="center">
![screenshot-20240730-161141.png](./user-agent/screenshot-20240730-161141.png)
...
<p align="center">
![screenshot-20240730-154623.png](./user-agent/screenshot-20240730-154623.png)
...
<p align="center">
![screenshot-20240730-163530.png](./user-agent/screenshot-20240730-163530.png)
*경로 지정 팝업*
</p>
...
<p align="center">
![screenshot-20240730-153518.png](./user-agent/screenshot-20240730-153518.png)
*Agent &gt; Settings*
</p>
...
<p align="center">
![screenshot-20240730-153524.png](./user-agent/screenshot-20240730-153524.png)
*Agent &gt; App menu*
</p>
