...
QueryPie Version 9 시절부터 파트너 엔지니어에게 제공된 설치 도우미 프로그램입니다.
Harbor 라는 Container Registry 에 계정을 발급받아 Container Image 를 내려받을 수 있습니다.

릴리즈된 모든 버전의 제품을 설치할 수 있습니다.
...
2025년 8월 출시된 QueryPie ACP Community Edition 의 출시와 함께 최종 고객사와 파트너 엔지니어에게 제공된 설치 도우미 프로그램입니다.
Docker Hub 에 공개된 Container Image 를 내려받아 설치하는 방식입니다.

설치 과정이 자동화되어, 처음 설치하는 이용자가 제품을 쉽게 설치할 수 있습니다.
그러나, 실질적인 설치 과정은 setup.sh 의 설치 방식과 setup.v2.sh 의 설치 방식이 동등하며, setup.v2.sh 는 그 과정이 자동화되었고, Version 10 등 구버전의 설치를 지원하지 않는다는 차이가 있습니다.

Apple Silicon 을 사용하는 macOS 환경의 설치를 지원합니다.

릴리즈된 모든 버전의 제품이 제공되지 않습니다.
2025년 12월 현재 Version 11.1.2 가 제공됩니다.

자세한 설치 방법은 이 문서를 참조하세요: [Installation Guide - setup.v2.sh (KO)](installation/installation-guide-setupv2sh)
