...
![스크린샷 2024-08-01 오전 11.50.45.png](./system-architecture-overview-image-1.png)
...
QueryPie는 [https://querypie-poc.customer.com/](https://querypie-poc.customer.com/)과 같은 TLS 인증서가 적용된 웹서비스 URL 을 갖게 되며, 이를 구성하기 위해 TLS 인증서와 함께 Application Load Balancer 를 설정하는 것을 권장합니다.
...
![스크린샷 2024-08-01 오전 11.53.43.png](./system-architecture-overview-image-2.png)

Summary of System Architecture for Real Use

![](./system-architecture-overview-icon-1.svg)
