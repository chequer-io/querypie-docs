...
제품을 시험사용하려는 고객을 위하여, Community Edition 을 제공합니다: [QueryPie ACP Community Edition](../installation/querypie-acp-community-edition) Community Edition 이용자에게는 1년간 제품을 사용할 수 있는 라이선스가 제공되며, 1년 이후에도 라이선스를 연장하여 계속 사용할 수 있습니다.
