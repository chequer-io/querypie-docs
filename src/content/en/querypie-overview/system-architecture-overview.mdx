...
The trial evaluation binary package is identical to the version provided to customers.
Product features are managed by licenses installed and provided remotely by the vendor.
Evaluation licenses typically provide a usage period of 2-4 weeks.
