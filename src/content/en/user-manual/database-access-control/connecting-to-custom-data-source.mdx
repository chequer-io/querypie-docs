...
2. **Connection Not Possible Notice**
    ...
    * The following tooltip is displayed and connection via web is not possible: "Access is only possible through a proxy and cannot be accessed through the web. Please open the QueryPie Agent to connect to the Custom Data Source." <br/>
      <figure data-layout="center" data-align="center">
