...
For detailed information about proxy approval, please refer to the [Approval Additional Features (Proxy Approval, Resubmission, etc.) document](workflow/approval-additional-features-proxy-approval-resubmission-etc).
...
For how to check unconfirmed requests, please refer to the [Approval Additional Features (Proxy Approval, Resubmission, etc.) document](workflow/approval-additional-features-proxy-approval-resubmission-etc).
