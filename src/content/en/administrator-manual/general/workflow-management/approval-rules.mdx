...
Approval Rules refer to the workflow approval processes preset by administrators.
Approval rules are created for each request type, allowing you to configure approval stages from 1 to 4 levels and set assignee selection methods for each stage.
The Approval Rules page provides the following functions:
