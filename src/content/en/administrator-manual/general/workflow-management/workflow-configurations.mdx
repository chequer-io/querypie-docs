...
When this option is activated, queries are executed continuously up to the specified number, then wait for the specified interval (ms). This prevents DB load from executing large-scale queries.
