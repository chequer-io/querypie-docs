...
Running Queries provides functionality to check information about queries executed through Web editor, Workflow, and Proxy, and allows administrators to forcibly stop running queries when necessary. You can check whether executed queries are from Web Editor or executed through Workflow through the Executed From field in Running Queries.
...
<Callout type="info">
You can view query information executed through Proxy, but cannot stop them. If you want to stop them, you must stop the session in Proxy Management.
</Callout>
