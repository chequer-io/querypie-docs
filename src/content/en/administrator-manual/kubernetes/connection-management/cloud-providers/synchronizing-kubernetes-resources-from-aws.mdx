...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ✔️                                                                                                                                                                         | Dry Run or Synchronize synchronization start                                                      | Cluster synchronization started.                                                                                                                          |
| ✔️                                                                                                                                                                         | New cluster addition completed                                                                      | New Cluster is added: `{Cluster Name}` (`{API URL}`).                                                                                                     |
| ✔️                                                                                                                                                                         | Existing cluster information update completed                                                                 | Cluster `{Cluster Name}` is updated                                                                                                                       |
| ✔️                                                                                                                                                                         | Existing cluster removal completed                                                                      | Cluster `{Cluster Name}` is removed                                                                                                                       |
| ✔️                                                                                                                                                                         | Dry Run or Synchronize synchronization successfully completed                                                | Cluster synchronization succeeded.                                                                                                                        |
...
| ❌                                                                                                                                                                          | Synchronization failed due to duplicate cluster name already confirmed                                                          | Cluster synchronization failed. The cluster name "`{Cluster Name}`" is already in use by another cluster. To synchronize it, delete the existing cluster. |
| ❌                                                                                                                                                                          | Dry Run or Synchronize synchronization failed                                                   | Cluster synchronization failed. + `{additional statement}`                                                                                                |